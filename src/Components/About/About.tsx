      ...
      <div className="flex items-center bg-g-blue-3">
        <div className=" md:w-full max-w-7xl  my-0 mx-auto py-12 px-4">
          <h3 className="text-gray-800 text-3xl mb-4">
            <Underline color={'white'}> Hello, CCD’23</Underline>
          </h3>
          <p className=" lg:w-3/4 text-white text-base mb-4">
            ...
            Community Day India 2023. Our experts will tell you how Google Cloud
            Platform and Google Cloud Certifications can help you in accelerating
            your career by boosting your knowledge. During this event, you’ll also
            stand a chance to win exciting prizes and gain insights on Google Cloud
            Certifications.
          </p>
          <a
