  ...
  return (
    <div className="max-w-7xl my-12 mx-auto">
      <div className="text-3xl flex justify-center font-normal my-12 text-g-gray-8">
        CCD Pune 2022 Partners
      </div>

      <p className="mb-4 lg:mb-16 font-light text-center text-gray-500 sm:text-xl">
        We're thankful to all our sponsors who made CCD 2022 Pune amazing. <br />
        To become a sponsor, please email as at{' '}
        <a href="mailto:contact@gdgcloudpune.com">contact@gdgcloudpune.com</a>
      </p>
      <br />
        ...
        <div className="relative items-center w-full px-5 mx-auto md:px-12 lg:px-24 max-w-7xl">
          <div className="grid w-full grid-cols-1 gap-6 mx-auto lg:grid-cols-3">
            ...
            >
              <div className="p-6">
                <img
                  className="object-cover object-center w-fit mb-12 rounded-xl"
                  src={cfplogo}
                  alt="blog"
                />
                <h2 className="mb-8 text-xs font-semibold tracking-widest text-blue-600 uppercase">
                  CFS Platform Sponsor
                </h2>
              </div>
            </a>

            <a
              href="https://www.u-smart.ai"
              rel={'noreferrer'}
              className="no-underline"
              target="_blank"
            >
              <div className="p-6">
                <img
                  className="object-cover object-center mb-3 rounded-xl"
                  src={usmart}
                  width={230}
                  alt="blog"
                />
