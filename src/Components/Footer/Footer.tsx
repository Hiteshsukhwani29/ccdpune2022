const Footer = () => {
  return (
    <div>
      <footer
        className="mt-5 pb-3 text-center lg:text-left text-gray-600"
        style={{
      ...
      >
        <div className="max-w-7xl mx-auto text-center md:text-left">
          <div
            className="flex items-center flex-row justify-center py-4 md:justify-start mb-4 mx-6"
            style={{
          ...
          >
            ...
            <a href="https://twitter.com/gdgcloudpune" className="mr-6 text-gray-600">
              <svg
                aria-hidden="true"
                focusable="false"
                data-prefix="fab"
